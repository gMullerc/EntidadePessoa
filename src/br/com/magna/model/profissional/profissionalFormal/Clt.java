...
public abstract class Clt extends ProfissionalFormal {
	...
	public Clt(String nome, enumGenero genero, enumEtnia etnia, LocalDate dataDeNascimento, String certidaoDeNascimento,
			String rg, String cpf, int contato, Endereco endereco, String estadoCivil, enumEscolaridade escolaridade,
			enumSituacaoEscolar situacaoEscolar, String cargo, double remuneracao, int carteiraDeTrabalho,
			String nomeDaEmpresa, LocalDate diaDeInicio, int pis) {
